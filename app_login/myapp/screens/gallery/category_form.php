...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form class="form-horizontal" role="form" action="gallery/category_save" method="post" enctype="multipart/form-data">
            <input name="category_id" type="hidden" value="<?php echo (!empty($query->category_id)) ? $query->category_id : ''; ?>" />
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-6">
                        <div class="col-sm-12">
                            <label class="col-sm-6 col-md-6 control-label" for="form-field-1">Category Name <span class="eror"><?php echo form_error('category_name'); ?></span></label>
                            <input name="category_name" Placeholder="Category Name" type="text" class="form-control" value="<?php echo (!empty($query->category_name)) ? $query->category_name : ''; ?>" />
                        </div>
                    </div>

                    <div class="form-group col-6">
                        <div class="col-sm-12">
                            <label class="control-label" for="form-field-4">Select Gallery<span class="eror"><?php echo form_error('gallery_id'); ?></span></label>
