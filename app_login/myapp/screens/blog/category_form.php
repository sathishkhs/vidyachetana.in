	...
	<div class="card-body">
		<form class="form-horizontal" action="blog/category_save" method="post" enctype="multipart/form-data">
			<input name="category_id" type="hidden" value="<?php echo (!empty($query->category_id)) ? $query->category_id : ''; ?>" />
			<div class="card-body">
				<div class="row">
					<div class="form-group col-sm-12">
						<div class="col-sm-12">
							<label class="col-sm-6 col-md-6 control-label" placeholder="Menu name" for="form-field-1">Category Name<span class="eror"><?php echo form_error('category_name'); ?></span></label>
					...
					<div class="form-group col-sm-12">
						<div class="col-sm-12">
							<label class="col-sm-6 col-md-6 control-label" for="form-field-4">Category Description<span class="eror"><?php echo form_error('category_desc'); ?></span></label>
