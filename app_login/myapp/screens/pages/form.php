                ...
                <div class="card card-info">
                    ...
                    <form class="form-horizontals" method="POST" id="pages_form" name="pages_form" action="master/pages_save" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" id="gallery-id" style='display:none'>
                                <div class="col-xs-3 col-sm-3 col-md-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8 col-sm-8 col-md-8">
                                    <div class="form-group">
                                        <textarea name="page_content" id="page_content" rows="9" class="form-control summernote page_content" placeholder="Page Content" data-validation="required"><?php echo (!empty($query->page_content)) ? $query->page_content : '' ?></textarea>
                                    </div>
                                </div>
                            </div>
