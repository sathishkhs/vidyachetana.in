            ...
            <div class="col-xl-6 col-lg-6">
                <div class="contact-page__left">
                    ...
                    <div class="contact-page__contact-info">
                        ...
                        <p>Mother’s Day is a special occasion for all of us. It is a day dedicated to
                            honouring all mothers across the world. It is celebrated on the 2<sup>nd</sup> Sunday
                            of May every year. All of us celebrate this day in our own unique way.</p>
                            
                            <p>This year, make it a more special celebration by fulfilling another
                                mother’s dream of seeing her child receive education. Donate to
                                educate a student belonging to socio-economically weaker section.</p>
                               
                                    <h6 class="thm-text" style="margin-top: 15px; margin-bottom: 15px;">Honour your mother’s love &amp; care for you by celebrating with us
        &amp; enabling education for meritorious students. </h6>
                               
                        <p>We at Vidya Chetana provide scholarship to support meritorious students
hailing from socio-economically weaker sections to pursue and complete
their higher education. Your support will potentially transform lives of
...
<h4 class="section-title__tagline">BACKGROUND OF OUR BENEFICIARY STUDENTS</h4>
                ...
                <div class="section-title text-center">
                    ...
                    <h3 class="mt-40" style="color: #707876">Make a difference this Mother’s Day.</h3>
            ...
            <div class="col-xl-6 col-lg-6 order-first order-md-2">
                <div class="contact-page__form helping-one__right-form">
                    <form name="donate-form" action="<?php echo base_url(); ?>mothers-day" class="contact-page__main-form " id="donate-form"  method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="programme" value="mothers-day">
