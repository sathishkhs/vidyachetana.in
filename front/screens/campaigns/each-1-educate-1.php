        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="section-title text-center">
                    <span class="section-title__tagline">IMPACT SO FAR & SUPPORT NEEDED</span>
            ...
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="feature-one__single feature-one__single-3">
                    ...
                    <div class="feature-one__content">
                        ...
                        <p class="text-dark">Students received scholarship</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="feature-one__single feature-one__single-3">
                    ...
                    <div class="feature-one__content">
                        <h3 class="text-dark mb-0">7275</h3>
                        <p class="text-dark">Students required scholarship</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="feature-one__single feature-one__single-3">
                    ...
                    <div class="feature-one__content">
                        <h3 class="text-dark mb-0">1500</h3>
                        <p class="text-dark">Students who are waiting for scholarship</p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 mx-auto">
                <!-- <h1>Each 1 Educate 1 - Donate To Education</h1> -->
            </div>
                ...
                <div class="contact-page__left">
                    ...
                    <div class="contact-page__contact-info">
                        <div class="section-title">
                            <span class="section-title__tagline mt-4">Inclusive progress begins with inclusive education. </span>
                        </div>

                        <p>Transform lives of meritorious students hailing from socio-economically weaker sections by supporting their higher education. </p>

                        <h4 class="section-title__tagline"> Join our Each 1 Educate 1 campaign.</h4>

                        <p>Education invariably uplifts the society in a sustainable way. Education enables our student to grow up to be resourceful and self-reliant adults who can provide for themselves. </p>
                        <p>While education is the fundamental right of every student, economic disparity makes it inaccessible to a significant number of them. In an effort to bridge this gap, Vidya Chetana’s Scholarship Program was initiated to support meritorious students hailing from socio-economically weaker sections to pursue and complete their higher education.</p>

                        <h4 class="section-title__tagline">BACKGROUND OF OUR BENEFICIARY STUDENTS</h4>
                        <table class="table table-bordered">
                            <tr>
                                <td>Socio-economically weaker sections </td>
                                <td>Specially-abled  </td>
                                <td>Lost their parent/s to COVID-19 pandemic </td>
                            </tr>
                        </table>
                        <!--<h4 class="section-title__tagline">IMPACT SO FAR & SUPPORT NEEDED</h4>-->
                        <!--<table class="table table-bordered">-->
                        <!--    <tr>-->
                        <!--        <td>7,275 students required scholarship </td>-->
                        <!--        <td>5,775 students received scholarship </td>-->
                        <!--        <td>Help 1,500 students who are waiting for scholarship</td>-->
                        <!--    </tr>-->
                        <!--</table>-->
            ...
            <div class="col-xl-6 col-lg-6 order-first order-md-2">
                <div class="contact-page__form helping-one__right-form">
                    <form name="donate-form" action="<?php echo base_url(); ?>each-1-educate-1" class="contact-page__main-form " id="donate-form"  method="post" enctype="multipart/form-data">
                        <h3 class="text-center section-title__tagline">Change a Student's Life with Education</h3>
                        ...
                        <input type="hidden" name="programme" value="each-1-educate-1">
    ...
    <script type="text/javascript">
        window.onload = function() {
            ...
            $('#modal-close').on('click', function() {
                ...
                window.location.href = 'each-1-educate-1';
